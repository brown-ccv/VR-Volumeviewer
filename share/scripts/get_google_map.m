...
size_ = ['&size=' num2str(width) 'x' num2str(height)];
...
sensor = '&sensor=false';
url = [preamble location zoom size_ maptype format markers sensor key];
cal_url = [preamble cal_location zoom size_ maptype format markers sensor key];
